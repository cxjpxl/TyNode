...
function getRadio(j,it,direct){
	...
	//1、联赛匹配率要超过0.5
	//2、主客队匹配率要超过0.6
	if((radioparams[0]>0.6||radioparams[1]>0.6)&&radioparams[2]>0.45){//
		//这个匹配可以视为有效
...
//获取获取网站的配置
let AUrlList=['http://www.424680.com','http://www.9920333.com','http://www.083m.com','http://www.pj66692.com'];
