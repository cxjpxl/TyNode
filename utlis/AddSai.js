...
/*function  getSaiList() {
    ...
    addSaiName("CS卡拉奥华", "CS卡拉奥华大学",data);
    ...
    addSaiName("阿尔贾兹拉阿布扎比", "阿尔贾兹拉",data);
    ...
    addSaiName("洛特", "伏尔加格勒",data);
    addSaiName("馬格德堡", "马格德堡",data);
    ...
    addSaiName("十字軍", "克鲁萨德",data);
    addSaiName("杜肯奴", "邓根伦",data);
    ...
    addSaiName("阿美利加明尼路", "阿美利加MG",data);
    ...
    addSaiName("维也纳新城体育会", "维也纳新城",data);
    ...
    addSaiName("RCD Espanyol B", "爱斯宾奴B队",data);
    addSaiName("CF Igualada", "伊瓜拉达",data);
    addSaiName("巴雷达", "巴雷达巴洛皮",data);
    addSaiName("阿尔巴塞特", "阿尔巴塞特基金会",data);
    addSaiName("华拉度列 B", "华拉度列B队",data);
    addSaiName("CD Monte", "莫特",data);
    addSaiName("Sardoma CF", "萨度玛",data);
    ...
    addSaiName("France", "法国队(女)",data);
    addSaiName("Italy", "意大利(女)",data);
    ...
    addSaiName("Holland Park Hawks", "荷兰公园老鹰",data);
    addSaiName("University of Queensland (BPL)", "昆士兰科技大学",data);
    ...
    addSaiName("拉德尼克苏尔杜利察", "苏杜利察",data);
  ...
  /////////////////////////////////5.6/////////////////////////////////////
   ...
   //////////////////////5.9///////////////////////////////////
    ...
    addSaiName("FK Torpedo Izhevsk", "伊热夫斯克鱼雷",data);
    ...
    addSaiName("沙迪奧", "索利戈尔斯克矿工",data);
    addSaiName("埃森舍纳贝克", "埃森",data);
    addSaiName("USK安尼夫", "阿尼夫",data);
    addSaiName("NJS努爾米耶爾維", "NJS努尔米耶尔维",data);
    addSaiName("阿尔克奥克立尼", "阿尔基奥罗克林尼",data);
    addSaiName("纽曼", "格罗德诺涅曼",data);
    addSaiName("OLS奧陸", "OLS奥鲁",data);
    addSaiName("萨尔帕", "莎埃帕",data);
    addSaiName("TP-47托尔尼奥", "TP47",data);
    addSaiName("米克力", "MP米克力",data);
    addSaiName("Torpedo Minsk", "鱼雷明斯克",data);
    addSaiName("贝迪逊", "贝尔格莱德游击队",data);
    addSaiName("泽穆恩", "泽蒙",data);
    addSaiName("国际马德里", "英特纳辛纳马德里",data);
    addSaiName("艾美利亚 B", "阿尔梅里亚B队",data);
    addSaiName("桑特费流恩", "桑特菲路恩斯",data);
    addSaiName("巴巴达斯", "巴尔瓦达斯",data);
    addSaiName("霍塔", "贺塔",data);
    addSaiName("雷乌斯B", "雷乌斯B队",data);
    //////////////////////////////5.14////////////////////////////////////////
    addSaiName("Bulleen Lions", "布琳狮子",data);
    addSaiName("斯馬納", "斯马纳",data);
    addSaiName("巴爾瑙爾戴拿模", "巴尔瑙尔戴拿模",data);
    addSaiName("Hyundai Steel Red Angels", "现代制铁",data);
    addSaiName("丁加奴足球俱乐部2", "丁加奴II队",data);
    addSaiName("毕特夏", "维托沙",data);
    addSaiName("库夫-98", "古夫",data);
    addSaiName("PK-37伊萨尔米", "PK37",data);
    addSaiName("明斯克戴拿模", "明斯克迪纳摩",data);
    addSaiName("奧特 BK 2", "奥特B队",data);
    addSaiName("华拿伦加 2", "瓦勒伦加B队",data);
    addSaiName("斯迪努桑德斯", "斯登桑德",data);
    ...
    /////////////////5.16////////////////////////////////////////////
    addSaiName("Stiinta Miroslava", "米洛斯拉瓦",data);
    addSaiName("Vinh Long FC", "永隆",data);
    addSaiName("瓦伦泰凤凰", "瓦伦蒂勒",data);
    addSaiName("埃奇沃斯老鹰", "埃奇沃斯伊格斯",data);
    addSaiName("Ba Ria Vung Tau FC", "巴地头顿",data);
    addSaiName("隆安 2", "隆安II队",data);
    addSaiName("澳门宾菲加体育会", "澳门本菲卡",data);
    addSaiName("卡瑪紮", "卡马斯",data);
    addSaiName("Metaloglobus Bucuresti", "梅塔罗洛布斯",data);
    addSaiName("洛特伏尔加格勒 2", "伏尔加格勒II队",data);
    addSaiName("烏里揚諾夫斯克", "伏尔加乌里扬诺夫斯克",data);
    addSaiName("阿费匹斯", "阿富匹斯",data);
    addSaiName("Ripensia Timisoara", "里彭斯亚",data);
    addSaiName("Foresta Suceava", "福雷斯塔苏恰瓦",data);
    addSaiName("阿波罗利马斯素尔", "阿波罗利马素尔",data);
    addSaiName("佐克伊", "佐基利",data);
    addSaiName("亚分利多", "爱芬里多",data);
    addSaiName("恩多拉联", "杰斯克联",data);
    addSaiName("玛格丽塔 FC", "玛格瑞塔",data);
    addSaiName("基夫拿维克", "凯夫拉维克",data);
    ...
    addSaiName("麥克亞瑟公羊隊", "马卡瑟尔",data);
    addSaiName("咸史泰斯", "哈尔姆斯塔德",data);
    addSaiName("阿德米拉瓦克默德林", "阿德米拉",data);
    addSaiName("Pho Hien FC", "甫宪",data);
    addSaiName("Fishsan Khanh Hoa", "菲斯三庆和",data);
    addSaiName("拉明斯科土星", "土星",data);
    addSaiName("索科爾薩拉托夫", "索科尔萨拉托夫",data);
    addSaiName("艾卡拉", "RSD艾卡拉",data);
    addSaiName("波布伦斯", "坡步任瑟",data);
    ...
    addSaiName("Taby FK", "泰比",data);
    addSaiName("IFK Mora FK", "IFK莫拉",data);
    addSaiName("Real Zaragoza", "萨拉戈萨",data);
    addSaiName("HIFK赫尔辛基2", "HFK赫尔辛基II队",data);
    addSaiName("MiKi", "MiPK",data);
    addSaiName("佩特莎亚里", "JBK佩特莎亚里",data);
    addSaiName("萨布塔洛", "萨布塔罗提比利锡",data);
    addSaiName("苏库拉莫斯", "索库埃利亚莫斯",data);
    ...
    addSaiName("FNSW研究所", "新南威尔斯足球协会队",data);
    addSaiName("Kerala Blasters", "克瑞拉巴拉斯特斯",data);
    addSaiName("FC基塔", "基塔",data);
    addSaiName("KA 史梅纳", "斯马纳",data);
    addSaiName("Real Kashmir", "皇家克什米尔",data);
    addSaiName("Kallithea", "卡利地亚",data);
    addSaiName("挪萨比", "诺沙比",data);
    addSaiName("安克尔维斯马", "安科维斯玛",data);
    //////////////////////////5.25//////////////////////////////////////////////////
    addSaiName("Changnyeong", "昌宁",data);
    addSaiName("MFK Frydek-Mistek", "弗雷德克",data);
    ...
    addSaiName("布咸麦恩斯1905", "波希米亚1905",data);
    addSaiName("罗斯托克 Am", "汉莎罗斯托克青年队",data);
    addSaiName("卡爾斯耶拿", "USV耶拿",data);
    addSaiName("SC桑德", "桑德",data);
    addSaiName("喜百年", "希伯尼安",data);
    addSaiName("Tertnes IL", "特尔尼斯",data);
    addSaiName("Togo", "多哥",data);
    addSaiName("Barcelona Esportivo SP", "巴塞罗那艾斯波迪渥SP",data);
    addSaiName("莱尼/ KB雷克雅未克", "莱尼雷KB",data);
    addSaiName("Orense SC", "奥伦塞",data);
    addSaiName("伊塔拜亚纳 SE", "伊塔巴纳SE",data);
    addSaiName("卡皮尼斯 PB", "坎派恩斯PB",data);
    addSaiName("阿美利加诺", "欧美利坚诺RJ",data);
    addSaiName("Macapa AP", "马卡帕AP",data);
    addSaiName("4 de Julho PI", "祖尔柯PI",data);
    addSaiName("布鲁克林意大利", "布鲁克林意大利人",data);
    addSaiName("Seacoast United Mariners", "海岸联水手",data);
    addSaiName("格瑞特洛厄爾聯", "格瑞特洛厄尔联",data);
    addSaiName("弗吉尼亚海滩 FC", "维吉尼亚沙滩城",data);
    addSaiName("古兰尼队", "瓜拉尼",data);
    addSaiName("Deportivo Santani", "桑坦尼",data);
    addSaiName("Hindustan FC", "辛度斯坦",data);
    addSaiName("Chornomorets Odessa", "查诺莫斯",data);
    addSaiName("施塔尔热舒夫", "乌尼亚塔努",data);
    addSaiName("马里求斯", "毛里求斯",data);
    addSaiName("阿维亚斯维德尼克", "斯维德尼克",data);
    addSaiName("切比尼亞謝爾沙", "切比纳谢斯扎",data);
    ...
    addSaiName("什捷霍维采", "史特丘维瑟",data);
    addSaiName("立德雪平", "利科平斯",data);
    addSaiName("艾西", "艾西",data);
    addSaiName("Eslovs BK", "艾斯洛夫司",data);
    addSaiName("Tomelilla IF", "图默利拉",data);
    addSaiName("阿玛佐", "亚马逊格林姆斯塔",data);
    addSaiName("咸美顿", "汉密尔顿",data);
    addSaiName("SpVg Schonnebeck 1910", "斯从内贝克",data);
    addSaiName("SF Baumberg", "巴姆堡格",data);
    addSaiName("格雷米奥卡坦度文斯SP", "甘美奥卡坦度文斯SP",data);
    addSaiName("AA Francana SP", "弗兰卡那SP",data);
    addSaiName("AD Guarulhos SP", "瓜鲁贺斯SP",data);
    addSaiName("Jaguariuna SP", "雅瓜里乌纳SP",data);
    addSaiName("圣保罗市SP", "保利斯塔SP",data);
    addSaiName("CA Joseense SP", "乔斯恩斯SP",data);
    addSaiName("埃斯基爾斯蒂纳", "艾基图纳城",data);
    addSaiName("BTP Stal Brzeg", "布热格",data);
    addSaiName("庭达斯多克", "堤达斯托尔",data);
    addSaiName("比拉尔瓦", "维拉尔贝斯竞赛会",data);
    addSaiName("Wierzyca Pelplin", "维尔兹卡帕尔林",data);
    addSaiName("斯特灵大学", "士特宁大学",data);
    addSaiName("科斯禾", "柯斯沃尔",data);
    addSaiName("莫索马格亚罗瓦", "莫索马雅罗瓦",data);
    addSaiName("塞格雷德", "瑟格雷迪",data);
    addSaiName("洛夫琴采蒂涅", "洛夫琴",data);
    addSaiName("Mladost Ljeskopolje", "马拉多特吉斯科普",data);
...
/////////////////////////6.6//////////////////////////////////////////////////////////
    ...
    addSaiName("冈比亚", "甘比亚",data);
    addSaiName("威灵根", "维连根",data);
    addSaiName("萊索托", "赖索托",data);
    addSaiName("津巴布韦", "辛巴威",data);
    addSaiName("巴西佩洛塔斯RS", "布拉希尔佩洛塔斯RS",data);
    addSaiName("尤文图斯SP", "佐云图斯SP",data);
    addSaiName("里奥卡拉羅", "里奥克拉洛SP",data);
    addSaiName("费罗维亚里亚SP", "费罗维里亚SP",data);
    addSaiName("亞特蘭大席瓦貝克", "亚特兰大银猩",data);
    addSaiName("Miami FC 2", "迈阿密II队",data);
    addSaiName("夏洛特鹰队", "夏洛特鹰",data);
    addSaiName("理海谷联音速", "理海谷联",data);
    addSaiName("文图拉县", "文图拉考迪菲优升",data);
    addSaiName("TPS图尔库", "TPS杜古",data);
    addSaiName("于韦斯屈莱", "韦斯屈莱",data);
    addSaiName("基柏约恩苏", "吉波",data);
    addSaiName("維安斯博格斯IF", "维安斯博格斯",data);
    addSaiName("奧斯特倫", "奥斯特伦",data);
    addSaiName("哈瑟侯姆", "哈萨侯姆",data);
    addSaiName("泰比FC", "泰比",data);
    addSaiName("勃勒斯", "博尔奈斯",data);
    addSaiName("卡斯爾斯", "卡萨斯RJ",data);
    addSaiName("施蘭奴RJ", "施兰奴RJ",data);
    addSaiName("欧拉里亚", "奥拉里亚RJ",data);
    addSaiName("史特贾纳", "斯塔尔南",data);
    addSaiName("布雷登顿 IMG 学院", "IMG布雷登顿学院",data);
    addSaiName("Avai SC", "阿瓦伊SC",data);
    addSaiName("哥查瓜", "科尔查瓜",data);
    addSaiName("华盛顿联队", "华盛顿特区联",data);
    addSaiName("帕洛卡SC", "古兰尼SC",data);
    addSaiName("Camboriu FC SC", "卡玛博瑞尤SC",data);
    addSaiName("Operario de Mafra SC", "奥帕瑞奥斯SC",data);
    addSaiName("FC Monmouth", "蒙茅斯",data);
    addSaiName("Electric City Shock", "电城震动",data);
    addSaiName("帕尔玛斯", "彭马斯TO",data);
    addSaiName("古鲁皮 EC", "古鲁皮TO",data);
    addSaiName("SC梅特朴利塔诺", "麦罗波利塔诺SC",data);
    ...
    addSaiName("Spokane Shadow", "斯波坎暗影",data);
    ...
    addSaiName("沃恩", "韦恩威斯巴登",data);
    addSaiName("FC利沃夫", "沃尔姆斯",data);
    addSaiName("IFK Falkoping FF", "法科平",data);
    addSaiName("阿西里斯卡 IK", "西里斯卡图拉丁",data);
    addSaiName("Chapecoense SC", "乔沛高恩斯SC",data);
    addSaiName("法雀克", "福尔柯克",data);
    addSaiName("明尼苏达联", "坦帕湾暴徒",data);
    addSaiName("國際納什維爾", "国际纳什维尔",data);
    addSaiName("沼津青藍", "浅蓝沼津",data);
    addSaiName("Pusamania 婆罗洲", "婆罗洲",data);
    addSaiName("哈姆拉尼", "瀚姆拉尼尔阿古雷利",data);
    addSaiName("梅瑟镇", "莫瑟泰菲尔镇",data);
    addSaiName("比格爾斯威德城", "比格尔斯韦德",data);
    addSaiName("卢兹符拉迪沃斯托克", "卢恩吉亚",data);
    addSaiName("Nerang Soccer Club", "尼拉恩",data);
    addSaiName("圣彼德斯堡泽尼特II队", "圣彼得堡泽尼特II队",data);
    addSaiName("Nizhny Novgorod FC", "诺夫哥罗德",data);
    addSaiName("PFC Sochi", "PFC索治",data);
    addSaiName("FC Rotor", "伏尔加格勒",data);
    addSaiName("马模", "马尔默",data);
    addSaiName("MOL Vidi", "MOL维迪",data);
    addSaiName("杜迪蘭治", "F91 杜迪兰治",data);
    addSaiName("慕頓", "格里诺克慕顿",data);
    addSaiName("科尔多瓦中央队", "科尔多瓦圣地亚哥中央队",data);
    addSaiName("Afjet Afyonspor", "阿菲永士邦",data);
    addSaiName("甘士比", "格里姆斯比",data);
    addSaiName("艾迪索特镇", "艾迪索特",data);
    addSaiName("艾特宁咸", "艾青洽",data);
    addSaiName("布雷诺", "弗布罗",data);
    addSaiName("吉奥競技GO", "戈亚尼恩斯",data);
    addSaiName("韦甘比", "韦康比流浪者",data);
    addSaiName("圣巴特里克", "圣帕特里克",data);
    addSaiName("伊奥华", "约维尔",data);
    addSaiName("石威德", "威尔德斯通",data);
    addSaiName("埃布斯福利特", "艾贝斯费特联",data);
    addSaiName("東伯恩", "东伯恩",data);
    addSaiName("东瑟罗克联", "东土洛克",data);
    addSaiName("里安頓", "奥连特",data);
    addSaiName("史云顿", "斯温登",data);
    addSaiName("Ha Noi FC B ", "河内II队",data);
    addSaiName("史浩克零四青年队", "沙尔克04青年队",data);
    addSaiName("艾克马亚青年队", "阿尔克马尔青年队",data);
    addSaiName("比奥洛格", "兹纳米亚",data);
    addSaiName("FC Chertanovo Moscow 2", "切塔罗沃莫斯科II队",data);
    ...
    addSaiName("岡崎丸山", "冈崎丸山",data);
    addSaiName("格魯洛森岡", "盛冈戈鲁拉",data);
    addSaiName("佩斯普拉查雅普拉", "查亚普拉佩西普拉",data);
    addSaiName("长野", "长野琶扼搂",data);
    addSaiName("法克尔", "沃罗涅日火炬",data);
    addSaiName("索治", "PFC索治",data);
    addSaiName("下诺夫哥罗德", "诺夫哥罗德",data);
    addSaiName("Hung Vuong An Giang", "安江",data);
    addSaiName("尼达克", "波格尼尔德空",data);
    addSaiName("阿斯基伦夏普尔", "阿什凯泽夏普尔",data);
    addSaiName("飞燕诺", "费耶诺德",data);
    addSaiName("阿沙芬堡维多利亚", "阿沙芬堡",data);
    addSaiName("罗连安特", "洛里昂",data);
    addSaiName("維利法蘭", "维利法兰",data);
    addSaiName("马里格纳拿吉尼亚克", "吉尼亚克",data);
    addSaiName("杜蘭斯", "杜兰斯",data);
    addSaiName("布雷流浪", "布雷",data);
    addSaiName("FC協會隊", "协会队",data);
    addSaiName("Newry City AFC", "纽维城",data);
    addSaiName("波希米亚人", "布咸美恩斯",data);
    ...
    addSaiName("馬迪堡", "马格德堡",data);
    addSaiName("慕士達", "普鲁士明斯特",data);
    addSaiName("SpVgg Ansbach", "安斯巴赫",data);
    addSaiName("瓦爾斯格呂奧", "瓦尔斯格吕纳",data);
    addSaiName("TSV 席尔克泽", "席尔克",data);
    addSaiName("TSV Bordesholm", "博德斯霍尔姆",data);
    addSaiName("Turk Gucu Friedberg", "土耳古库弗里德伯格",data);
    addSaiName("Al Fayha FC", "费哈",data);
    addSaiName("FC Eddersheim", "埃德尔斯海姆",data);
    addSaiName("鲍纳塔尔", "保纳塔尔",data);
    addSaiName("FC Monheim", "蒙海姆",data);
    addSaiName("TV Jahn Hiesfeld", "贾恩希斯菲尔德",data);
    addSaiName("C Velbert", "SC维柏特",data);
    addSaiName("TSV Meerbusch", "梅尔布施",data);
    addSaiName("克莱韦", "克雷夫",data);
    addSaiName("里奧普雷图SP", "里奥沛图SP",data);
    addSaiName("沙拉捷禾", "撒拉捷沃",data);
    addSaiName("達寧頓", "达宁顿",data);
    addSaiName("FC Prykarpattia", "普瑞卡帕提亚",data);
    addSaiName("达伊纳瓦阿利图斯", "DFK戴拿瓦",data);
    addSaiName("阿姆斯登", "阿姆施泰滕",data);
    addSaiName("因斯布鲁克瓦克尔Am", "因斯布鲁克青年队",data);
    addSaiName("高宁根", "格罗宁根",data);
    addSaiName("PSV燕豪芬青年队", "PSV埃因霍温青年队",data);
    addSaiName("恩浩云", "埃因霍温",data);
    addSaiName("阿积士青年队", "阿贾克斯青年队",data);
    addSaiName("阿高斯", "前进之鹰",data);
    addSaiName("华伦丹", "沃伦丹",data);
    addSaiName("丹博斯治", "邓伯什",data);
    addSaiName("川迪", "特温特",data);
    addSaiName("託奧斯", "奥斯",data);
    ...
    addSaiName("云罗里八戶", "万劳雷八户",data);
    addSaiName("哈化柏林Am", "哈化柏林青年队",data);
    addSaiName("基尔高士丁AM", "荷尔斯泰因青年队",data);
